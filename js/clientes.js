...
`;
            ...
            // Main stats for the reservation (like in your image)
            ...
            for (let i = 1; i <= cantidadPasajeros; i++) {
                ...
                const isPaxFinished = diasRestantesPax === 0 && diasPax > 0; // Consider pax finished if days remaining is 0 and had total days
    ...
    activeReservationsBtn.addEventListener('click', () => displayReservations('active'));
    finishedReservationsBtn.addEventListener('click', () => displayReservations('finished'));
